            ...
            <form action="config_rest.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="mem_id" value="<?php echo $result['mem_id']; ?>">
                    <div class="col-2">
                        ...
                        <select class="form-select" name="cate_id">
                            ...
                            <option value="<?php echo $result2["cate_id"];?>">
                                <?php echo "{$result2["cate_id"]} : {$result2["cate_name"]}";?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-3"> 
                        <label class="col-form-label">Category Name</label>
                        <input type="text" name="cate_name" class="form-control" disabled
                    ...
                    <div class="col-6">
                        ...
                        <input type="time" step="60" class="form-control" name="o_hr" value="<?php echo$result["o_hr"]; ?>">
                    </div>
                    <div class="col-6">
                        <label class="col-form-label">Close</label>
                        <input type="time" step="60" class="form-control" name="c_hr" value="<?php echo$result["c_hr"]; ?>" >
                    </div>
                </div>
                <center><img src="../asset/uploads/<?php echo $result['res_img']; ?>" class="img-fluid my-4" width="50%"
                        height="50%" style="width: 600px; height: 300px; object-fit: cover;"></center>
                        <input type="file" name="file" class="form-control">
                <button type="submit" name="update" class="btn btn-primary form-control my-3">UpDate</button>
            </form>
        </div>
    </div>
</body>
